   ...
   //    String t = "";
		...
		switch (op) {
			...
			case '^':
				...
				break;
                       case '√':	
                           st.add(Math.sqrt(Double.valueOf(l)));  
				break;
		}
	}
...
public void vkl()
    ...
    private void jTextField1KeyTyped(java.awt.event.KeyEvent evt) {                                     
        ...
        if(!(Character.isDigit(non)) || non  == '+' || non  == '-'|| non  == '*' || non  == '/'
                || non  == '.' || non  == '^' || non  == '%' ||  evt.getKeyCode()==48 || evt.getKeyCode()==57  )/* || (non ==KeyEvent.VK_BACK_SPACE)) ||
...
mathematic();
 ...
 num = Double.parseDouble(jTextField1.getText());
        calculation = 17;
       // jLabel1.setText("Заокруглено до: " + num);
             mathematic();
